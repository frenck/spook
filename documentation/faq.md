...
Spook is and remains a custom integration, that is not supported, maintained, or endorsed by the Home Assistant project. Just like any other custom integration out there. It is up to you to decide if you are comformtable using a custom integration or not.
```
