...
Spook is the a rebel, and will not follow the rules of Semantic Versioning, instead it uses the following rules:

- `MAJOR`: If there is almost nothing changed, or a lot has changed.
- `MINOR`: No idea, possibily breaking, or not.
...
Sorry, no ETA. This is a pet project on which I work on in my spare time. I will release a new version when I feel like it.
```
